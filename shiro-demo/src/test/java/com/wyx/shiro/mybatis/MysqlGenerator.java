...
public class MysqlGenerator {
    ...
    public static DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig().setDbType(DbType.MYSQL) // 数据库类型
                .setUrl("jdbc:mysql://localhost:3306/my_shiro?characterEncoding=utf8&serverTimezone=CTT")
...
//        String[] includeTableNames = {"qd_dictionary"}; // 需要生成的表 "ord_api_access_log", "ord_order_invoice", "ord_order_invoice_item"
        String[] includeTableNames = {"sys_user","sys_role","sys_menu","sys_user_role","sys_role_menu"};

        // 自定义需要填充的字段
        List<TableFill> tableFillList = new ArrayList<>();
        //tableFillList.add(new TableFill("ASDD_SS", FieldFill.INSERT_UPDATE));
        String controllerTemplatePath = "/templates/mybatis/controller.java";
        String entityTemplatePath = "/templates/mybatis/entity.java";
        String mapperTemplatePath = "/templates/mybatis/mapper.java";
        String serviceTemplatePath = "/templates/mybatis/service.java";
        String serviceImplTemplatePath = "/templates/mybatis/serviceImpl.java";
        ...
        // 生成自定义的 model
        controllerTemplatePath = "/templates/mybatis/model.java";
        ...
        /*
        // 生成自定义的 model
        controllerTemplatePath = "/templates/mybatis/attributeMethod.java";
    ...
    public static InjectionConfig getInjectionConfig(String outputDir) {
        ...
        }.setFileOutConfigList(Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mybatis/mapper.xml.ftl") {
            @Override
